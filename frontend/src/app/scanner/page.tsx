...
export default function ScannerPage(){
 ...
 const runScanner=useCallback(async()=>{
  ...
  runningRef.current=true;setScanning(true);setError(null);setProgress("Building max-200 scanner universe");
  try{
 ...
 return <div className="pageWrap">
  <div className="pageHeader"><div><p className="eyebrow">Market Intelligence</p><h1>Scanner</h1><p className="muted">Binance metadata → max 200 unique coin scan pool → top 30 → Indicator Engine → Scanner shortlist.</p></div><span className="modePill"><span />{scanning?"Scanner running":autoRun?"Auto scan active":"Scanner ready"}</span></div>
...
const pipelineWrap={display:"grid",gridTemplateColumns:"repeat(10,minmax(125px,1fr))",gap:10,marginTop:18,overflowX:"auto",paddingBottom:4} as const;
